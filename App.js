...
export default function App() {
  ...
  async function startRecording() {
    try {
      ...
      let { recording } = await Audio.Recording.createAsync(Audio.RecordingOptionsPresets.HIGH_QUALITY
      );
      audio = recording
    ...
    <View style={styles.container}>
      ...
      <Modal visible={isDialogVisible} animationType="slide" style={styles.modal}>
        <View style={styles.column}>
          ...
          <TextInput
            style={{ height: 40, borderColor: 'gray', borderWidth: 1, marginBottom: 10, padding: 10, width: 200, borderRadius: 20 }}
          ...
          return (
            <View key={index}>
              ...
              <TouchableOpacity onPress={async () => {
                ...
                <Ionicons name="trash" size={30} color="white" onPress={() => {
